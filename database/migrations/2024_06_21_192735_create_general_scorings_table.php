...
return new class extends Migration
{
    ...
    {
        Schema::create('general_scorings', function (Blueprint $table) {
            $table->id();
            ...
            $table->tinyInteger('s29', false, true);
            $table->tinyInteger('s30', false, true);
            $table->tinyInteger('s31', false, true);
            $table->tinyInteger('s32', false, true);
    ...
    {
        Schema::dropIfExists('general_scorings');
    }
};
